...
export default function RegisterPage() {
  ...
  const onSubmit = useCallback(async (data: RegisterFormValues) => {
    ...
    try {
      ...
      if (error?.code) {
        const errorMap = {
          USER_ALREADY_EXISTS: "Email already registered. Please use a different email or sign in instead."
        };
        toast.error(errorMap[error.code as keyof typeof errorMap] || "Registration failed. Please try again.");
        return;
      }
